export default {
    ...
    },
    {
      ...
      description: "Fair & Clear is Pakitan's only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are no side effects.",
      price: 70,
